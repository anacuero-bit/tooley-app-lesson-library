...
v2.7.0 (2026-01-29)
  ...
  - FIXED: Back to menu button from help screen
  - NEW: Chat+HTML format option (in addition to Chat+PDF)
...
# ============================================================================
# PDF GENERATION - v2.7.0 Complete Rewrite
# ============================================================================

class LessonPDF(FPDF):
    """Custom PDF class for lesson plans with Tooley branding.
    
    v2.7.0: Complete rewrite for reliability. No fancy parsing, just clean output.
    """
    ...
    def write_specs(self, params: dict):
        """Write lesson specifications box."""
        ...
        for label, value in specs:
            ...
            self.cell(0, 5, self.safe(value))
            self.ln(5)
        
        self.set_y(y_start + box_h + 8)
    
    def write_content(self, content: str):
        """Write lesson content line by line."""
        self.set_font('Helvetica', '', 10)
        self.set_text_color(15, 23, 42)
